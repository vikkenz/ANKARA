...
$query = $pdo->query("SELECT * from vendas where pago != 'Sim' and ref_api is not null and loja = '$id_usuario' order by id desc");
...
<input type="hidden" id="ids">
	...
	<!-- Modal Pedidos -->
	<div class="modal fade" id="modalPedidos2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<input type="hidden" id="id_dos_ped">
<input type="hidden" id="sessao_dos_ped">
    ...
    $.ajax({
        ...
        success: function (mensagem) {
            ...
            if (mensagem.trim() == "Salvo com Sucesso") {
                ...
                //atualizar tela pedidos
                var id = $('#id_dos_ped').val();
				var sessao = $('#sessao_dos_ped').val();		
