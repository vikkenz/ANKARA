...
<td style="color:{$classe_ativo}" class="esc"><img src="../painel/images/categorias/{$foto}" width="25px"></td>
<td>
...
<script type="text/javascript">
	function editar(id, nome, descricao, foto){
    	...
    	$('#target').attr('src','../painel/images/categorias/' + foto);		
	...
	function limparCampos(){
    	...
    	$('#target').attr("src", "../painel/images/categorias/sem-foto.png");
