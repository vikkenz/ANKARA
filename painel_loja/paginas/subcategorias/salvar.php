...
//validacao nome
$query = $pdo->query("SELECT * from $tabela where nome = '$nome' and categoria = '$categoria' and id_loja = '$id_usuario'");
...
$caminho = '../../../painel/images/subcategorias/' .$nome_img;
...
if(@$_FILES['foto']['name'] != ""){
	...
	if($ext == 'png' or $ext == 'jpg' or $ext == 'jpeg' or $ext == 'gif' or $ext == 'webp' or $ext == 'PNG' or $ext == 'JPG' or $ext == 'JPEG' or $ext == 'GIF' or $ext == 'WEBP'){ 
			...
			if($foto != "sem-foto.png"){
				@unlink('../../../painel/images/subcategorias/'.$foto);
			}
...
if($id == ""){
$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, descricao = :descricao, imagem = '$foto', ativo = 'Sim', categoria = :categoria, url = :url, id_loja = '$id_usuario'");
