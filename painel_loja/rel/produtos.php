...
$filtrar_estoque = $_GET['filtrar_estoque'];
...
if($categoria != ""){
	$query = $pdo->query("SELECT * from produtos where loja = '$id_usuario' and categoria = '$categoria' $sql_estoque order by id desc");
	if($subcategoria != ""){
		$query = $pdo->query("SELECT * from produtos where loja = '$id_usuario' and categoria = '$categoria' and subcategoria = '$subcategoria' $sql_estoque order by id desc");
	}
}else{
	$query = $pdo->query("SELECT * from produtos where loja = '$id_usuario' $sql_estoque order by id desc");
}
