...
$query2 = $pdo->query("SELECT * from avaliacoes where produto = '$produto' and cliente = '$id_usuario'");
$res2 = $query2->fetchAll(PDO::FETCH_ASSOC);
...
<td>
	...
	<a href="#" title="Avaliar Produto" onclick="avaliar('{$id}', '{$produto}', '{$nome_produto}', '{$venda}')" class="btn btn-warning btn-sm {$ocultar_avaliar}"  ><i class="fa fa-star-o "></i> </a>
</td>
