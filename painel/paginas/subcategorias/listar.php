...
if($busca == ""){
	...
	$query = $pdo->query("SELECT * from $tabela where categoria = '$busca' and id_loja is null order by id desc");
}
...
<td style="color:{$classe_ativo}" class="esc"><img src="images/subcategorias/{$foto}" width="25px"></td>
<td>
...
<script type="text/javascript">
	function editar(id, nome, descricao, foto, categoria){
    	...
    	$('#target').attr('src','images/subcategorias/' + foto);	
	...
	function limparCampos(){
    	...
    	$('#target').attr("src", "images/subcategorias/sem-foto.png");
