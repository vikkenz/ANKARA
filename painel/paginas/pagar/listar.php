...
<td>
	<big><a class="icones_mobile" href="#" onclick="editar('{$id}','{$descricao}','{$valor}','{$fornecedor}','{$funcionario}','{$vencimento}','{$data_pgto}','{$forma_pgto}','{$frequencia}','{$obs}','{$tumb_arquivo}','{$loja}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
