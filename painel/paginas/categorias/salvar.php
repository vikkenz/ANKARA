...
//validacao nome
$query = $pdo->query("SELECT * from $tabela where nome = '$nome' and id_loja is null");
...
if($id == ""){
$query = $pdo->prepare("INSERT INTO $tabela SET nome = :nome, descricao = :descricao, imagem = '$foto', ativo = 'Sim', url = :url");
