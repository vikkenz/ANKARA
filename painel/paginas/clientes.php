...
<div class="justify-content-between">
	<div class="left-content mt-2 mb-3">
		...
		<select class="form-select" name="ativo" id="ativo" onchange="$('#ativo_status').val($('#ativo').val()); buscar()" style="width:150px; display:inline-block; margin-left: 20px">
			<option value="">Todos</option>
			<option value="Sim">Aprovados</option>
			<option value="Não">Pendentes</option>
		</select>
		<input type="hidden" name="ativo_status" id="ativo_status">
			...
			<form id="form">
				...
				<div class="row">
					...
					<div class="col-md-2 mb-2">							
							...
							<input type="text" class="form-control" id="url" name="url" placeholder="Url Loja" required>							
						</div>
				...
				<input type="hidden" class="form-control" id="ativo" name="ativo" value="Sim">						
						...
						<div class="tile">
							<div class="table-responsive">
								<table id="" class="text-left table table-bordered">
									...
									<tr>
										<td class="bg-warning alert-warning w_150">Url Loja</td>
										<td><a id="url_dados_link" target="_blank"><span id="url_dados"></span></a></td>
									</tr>
