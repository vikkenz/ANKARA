...
//verificar se tem pedidos com mais de x dias sem pagar
$data_excluir_pedidos =  date('Y/m/d', strtotime("-$dias_excluir_pedidos days",strtotime($data_atual)));
$query = $pdo->query("SELECT * from vendas where data <= '$data_excluir_pedidos'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$linhas = @count($res);
if($linhas > 0){
	for($i=0; $i<$linhas; $i++){
	$id = $res[$i]['id'];
	$sessao_c = $res[$i]['sessao'];
		$pdo->query("DELETE FROM vendas where id = '$id'");
		$pdo->query("DELETE FROM carrinho where venda = '$id'");
		$pdo->query("DELETE FROM temp where sessao = '$sessao_c'");
	}
}
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<li class="slide <?php echo @$menu_pessoas ?>">
									...
									<li class="<?php echo @$clientes ?>"><a class="slide-item" href="clientes"> Clientes / Lojas</a></li>
								...
								<li class="slide <?php echo @$menu_cadastros ?>">
									...
									<ul class="slide-menu">
										...
										<li class="<?php echo @$subcategorias ?> "><a class="slide-item" href="subcategorias"> Sub Categorias</a></li>

										<li class="<?php echo @$envios ?> "><a class="slide-item" href="envios"> Envios</a></li>
									...
									<li class="<?php echo @$banners ?> "><a class="slide-item" href="banners"> Banners</a></li>

									<li class="<?php echo @$cupons ?> "><a class="slide-item" href="cupons"> Cupons</a></li>
								...
								<li class="slide <?php echo @$menu_financeiro ?>">
									...
									<a class="side-menu__item" href="pedidos">
										...
										<li class="slide <?php echo @$avaliacoes ?>">
									<a class="side-menu__item" href="avaliacoes">
										<i class="fa fa-star text-white"></i>
										<span class="side-menu__label" style="margin-left: 15px">Avaliações</span></a>
								</li>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row mb-3">
						...
						<div class="col-md-2">							
								<label>Tipo</label>
								<select name="tipo_loja" id="tipo_loja" class="form-select">
									<option value="Marketplace" <?php if(@$tipo_loja == 'Marketplace'){ ?> selected <?php } ?>>Marketplace</option>
									<option value="MultiLojas" <?php if(@$tipo_loja == 'MultiLojas'){ ?> selected <?php } ?>>MultiLojas</option>
								</select>						
						</div>
					...
					<div class="row mb-3">						
						...
						<div class="col-md-2">							
								...
								<input type="number" class="form-control" name="comissao_mk" placeholder="Marketplace" value="<?php echo @$comissao_mk ?>">			
						</div>

							<div class="col-md-2">							
								<label>Dias Pgto</label>
								<input type="number" class="form-control" name="dias_pgto_comissao" placeholder="Comissão" value="<?php echo @$dias_pgto_comissao ?>">			
						</div>

						<div class="col-md-2">							
								<label>Aprovar Loja</label>
								<select name="aprovar_loja" class="form-select">
									<option value="Sim" <?php if($aprovar_loja == 'Sim'){ ?> selected <?php } ?>>Sim</option>
									<option value="Não" <?php if($aprovar_loja == 'Não'){ ?> selected <?php } ?>>Não</option>
								</select>						
						</div>
						...
						<div class="col-md-3">							
								<label>Aprovar Produtos</label>
								<select name="aprovar_produtos" class="form-select">
									<option value="Sim" <?php if($aprovar_produtos == 'Sim'){ ?> selected <?php } ?>>Sim</option>
									<option value="Não" <?php if($aprovar_produtos == 'Não'){ ?> selected <?php } ?>>Não</option>
								</select>						
						</div>
					

						<div class="col-md-3">							
								<label>Loja se Cadastrar</label>
								<select name="cadastro_loja" class="form-select">
									<option value="Sim" <?php if($cadastro_loja == 'Sim'){ ?> selected <?php } ?>>Sim</option>
									<option value="Não" <?php if($cadastro_loja == 'Não'){ ?> selected <?php } ?>>Não</option>
								</select>						
						</div>
						...
						<div class="row mb-3">
							<div class="col-md-3">							
								...
								<input type="number" class="form-control" id="itens_paginacao" name="itens_paginacao"  value="<?php echo @$itens_paginacao ?>">			
						</div>

						<div class="col-md-6">							
								<label>Token Frete Melhor Envio</label>
								<input type="text" class="form-control" id="token_frete" name="token_frete"  value="<?php echo @$token_frete ?>">			
						</div>

						
							<div class="col-md-3">							
								<label>Dias Excluir Pedidos</label>
								<input type="number" class="form-control" id="dias_excluir_pedidos" name="dias_excluir_pedidos"  value="<?php echo @$dias_excluir_pedidos ?>">			
						</div>
